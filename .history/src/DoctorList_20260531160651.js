...
<div className="flex-1 w-full flex flex-col items-start text-left space-y-1 text-black">
  ...
  <div className="flex justify-between items-center w-full text-sm">
    ...
    <div className="flex items-center gap-1 bg-yellow-100 px-2 py-1 rounded-full border border-orange-300">  <span className="font-semibold text-green-700 text-sm">
