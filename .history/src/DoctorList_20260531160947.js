...
<div className="w-full mt-2 bg-blue-50 border border-blue-200 rounded-lg shadow-sm overflow-hidden text-xs">      <div className="flex items-center gap-1 px-2 py-1 bg-gray-100 border-b">
        <span>📅</span>
