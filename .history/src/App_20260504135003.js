...
const handleLogin = async () => {
  ...
  return (
    ...
    >
      {/* Blur overlay removed for full opacity */}
      ...
      >
        ...
        <div className="panel-right">
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            />
            {emailError && (
              <p id="email-error" style={{ color: "#f87171", fontSize: 12, marginTop: 4 }}>
                {emailError}
              </p>
            )}
          </div>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            />
            {passwordError && (
              <p id="password-error" style={{ color: "#f87171", fontSize: 12, marginTop: 4 }}>
                {passwordError}
              </p>
            )}
          </div>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            {practiceError && (
              <p id="practice-error" style={{ color: "#f87171", fontSize: 12, marginTop: 4 }}>
                {practiceError}
              </p>
            )}
          </div>
