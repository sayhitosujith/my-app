        ...
        {currentAppointments.length === 0 ? (
          ...
          currentAppointments.map((item) => {
            ...
            return (
              ...
              <p><b>Appointment Type:</b> {Array.isArray(item.type) ? item.type.join(", ") : item.type || "-"}</p>

<p><b>Consultation Mode:</b> {item.consultationType || "-"}</p>
...
<p><b>Scheduled Dentist:</b> {item.dentist || "-"}</p>
