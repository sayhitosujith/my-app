...
const [currentCity, setCurrentCity] = useState("");
  ...
  {/* SHOW CURRENT CITY */}
  {currentCity && (
  <span className="flex items-center gap-2 text-sm font-semibold text-white-900 whitespace-nowrap border border-orange-400 rounded-lg px-3 py-1 bg-orange-500">
