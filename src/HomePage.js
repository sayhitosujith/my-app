...
<br></br>
    ...
    <footer className="relative w-full">
      <div className="mx-auto w-full max-w-7xl px-8">
        ...
        <div className="mt-12 flex w-full flex-col border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal text-blue-gray-900 md:mb-0"
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Maven Meal</a>. All
            Rights Reserved.
          </Typography>
